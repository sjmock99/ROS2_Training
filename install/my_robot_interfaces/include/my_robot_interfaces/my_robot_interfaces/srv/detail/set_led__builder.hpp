...
class Init_SetLed_Request_led
{
public:
  Init_SetLed_Request_led()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetLed_Request_state led(::my_robot_interfaces::srv::SetLed_Request::_led_type arg)
  {
...
{
  return my_robot_interfaces::srv::builder::Init_SetLed_Request_led();
}
