...
#ifndef TURTLESIM_PKG_MSGS__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
#define TURTLESIM_PKG_MSGS__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
 ...
 * calls
 * turtlesim_pkg_msgs__srv__CatchTurtle_Request__init().
...
/**
 * It calls
 * turtlesim_pkg_msgs__srv__CatchTurtle_Request__fini()
 ...
 * turtlesim_pkg_msgs__srv__CatchTurtle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * turtlesim_pkg_msgs__srv__CatchTurtle_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtlesim_pkg_msgs__srv__CatchTurtle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_pkg_msgs
...
/**
 * It calls
 * turtlesim_pkg_msgs__srv__CatchTurtle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_pkg_msgs
...
/**
 * It allocates the memory for the array and calls
 * turtlesim_pkg_msgs__srv__CatchTurtle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_pkg_msgs
...
/**
 * It calls
 * turtlesim_pkg_msgs__srv__CatchTurtle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TURTLESIM_PKG_MSGS__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
