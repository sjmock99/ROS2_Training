...
bool turtlesim_pkg_msgs__msg__turtle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlesim_pkg_msgs.msg._turtle.Turtle", full_classname_dest, 37) == 0);
  }
  turtlesim_pkg_msgs__msg__Turtle * ros_message = _ros_message;
  {  // turtle_name
...
PyObject * turtlesim_pkg_msgs__msg__turtle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlesim_pkg_msgs.msg._turtle");
