...
#include "turtlesim_pkg_msgs/msg/detail/turtle__rosidl_typesupport_fastrtps_c.h"
...
using _Turtle__ros_msg_type = turtlesim_pkg_msgs__msg__Turtle;
...
static uint32_t _Turtle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlesim_pkg_msgs__msg__Turtle(
...
static size_t _Turtle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlesim_pkg_msgs__msg__Turtle(
